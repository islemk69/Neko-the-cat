...
const createGibworkTaskAction = {
    ...
    handler: async (agent, input) => {
        try {
            const responseData = await (0, tools_1.create_gibwork_task)(agent, input.title, input.content, input.requirements, input.tags, new web3_js_1.PublicKey(input.tokenMintAddress), input.tokenAmount, input.payer ? new web3_js_1.PublicKey(input.payer) : undefined);
            return {
                status: "success",
