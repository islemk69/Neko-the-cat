...
export class Global {
    ...
    static deserializeGlobalBuffer(data) {
        ...
        offset += 2;
        const globalDeposits = globalAmountsRootIndex != NIL
            ? deserializeRedBlackTree(data.subarray(FIXED_GLOBAL_HEADER_SIZE), globalAmountsRootIndex, globalDepositBeet)
            : [];
        return {
            mint,
            vault,
