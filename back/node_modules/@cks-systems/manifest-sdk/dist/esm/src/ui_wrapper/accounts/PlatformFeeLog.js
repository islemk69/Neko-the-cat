 ...
 * @category generated
 */
export class PlatformFeeLog {
    market;
    user;
    mint;
    platformTokenAccount;
    platformFee;
    constructor(market, user, mint, platformTokenAccount, platformFee) {
        this.market = market;
        this.user = user;
        this.mint = mint;
    ...
    static fromArgs(args) {
        return new PlatformFeeLog(args.market, args.user, args.mint, args.platformTokenAccount, args.platformFee);
    }
    /**
