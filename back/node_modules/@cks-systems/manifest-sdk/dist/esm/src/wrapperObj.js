...
import { marketInfoBeet, wrapperOpenOrderBeet, } from './wrapper/types';
    ...
    static deserializeWrapperBuffer(data) {
        ...
        const parsedMarketInfos = marketInfos.map((marketInfoRaw) => {
            ...
            const rawOpenOrders = rootIndex != NIL
                ? deserializeRedBlackTree(data.subarray(FIXED_WRAPPER_HEADER_SIZE), rootIndex, wrapperOpenOrderBeet)
                : [];
