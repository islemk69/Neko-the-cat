...
async function testWrapper() {
    ...
    {
        const setup = await UiWrapper.setupIxs(connection, payerKeypair.publicKey, payerKeypair.publicKey);
    ...
    assert(wrapper.marketInfoForMarket(marketAddress) == null, 'no seat claimed yet in market');
    {
        const tx = new Transaction();
