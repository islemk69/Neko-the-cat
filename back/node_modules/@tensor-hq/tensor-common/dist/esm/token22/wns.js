...
export const WNS_DIST_PROGRAM_ID = new PublicKey('diste3nXmK7ddDTs1zb6uday6j4etCa9RChD8fJ1xay');
export const findWNSGroupPda = (mint) => {
...
export const findWNSMemberPda = (mint) => {
...
export const findWNSApprovalPda = (mint) => {
...
export const findWNSExtraMetasPda = (mint) => {
...
export const findWNSDistributionPda = (collection) => {
    const [distributionAccount] = PublicKey.findProgramAddressSync([new PublicKey(collection).toBuffer()], WNS_DIST_PROGRAM_ID);
