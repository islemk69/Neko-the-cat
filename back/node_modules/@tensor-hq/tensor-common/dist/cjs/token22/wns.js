...
const findWNSDistributionPda = (collection) => {
    const [distributionAccount] = web3_js_1.PublicKey.findProgramAddressSync([new web3_js_1.PublicKey(collection).toBuffer()], exports.WNS_DIST_PROGRAM_ID);
